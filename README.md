...
[![Rust CI](https://github.com/still-silly/Stochastic-Volumetric-LED-Display/actions/workflows/ci.yml/badge.svg)](https://github.com/still-silly/Stochastic-Volumetric-LED-Display/actions/workflows/ci.yml)
...
Once you have the hardware, go to the [Wiki.](https://github.com/still-silly/Stochastic-Volumetric-LED-Display/wiki/Setting-up-LEDs)

For WLED, see the [hardware test checklist](docs/wled.md).
